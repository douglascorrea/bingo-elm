...
var _user$project$Bingo$totalItem = function (total) {
	return A2(
...
var _user$project$Bingo$totalPoints = function (entries) {
	return A3(
		_elm_lang$core$List$foldl,
		F2(
			function (e, sum) {
...
var _user$project$Bingo$pageFooter = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html_Attributes$href('http://github.com')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
			...
			default:
				var updateEntry = function (e) {
					return _elm_lang$core$Native_Utils.eq(e.id, _p0._0) ? _elm_lang$core$Native_Utils.update(
						e,
						{
							wasSpoken: _elm_lang$core$Basics$not(e.wasSpoken)
						}) : e;
				};
				return _elm_lang$core$Native_Utils.update(
					model,
...
var _user$project$Bingo$newEntry = F3(
	function (phrase, points, id) {
...
var _user$project$Bingo$initialModel = {
	entries: _elm_lang$core$Native_List.fromArray(
		[
			A3(_user$project$Bingo$newEntry, 'Doing Agile', 200, 2),
			A3(_user$project$Bingo$newEntry, 'In the Cloud', 300, 3),
			A3(_user$project$Bingo$newEntry, 'Future Proof', 100, 1),
			A3(_user$project$Bingo$newEntry, 'Rock-Star Ninja', 400, 4)
		])
};
...
var _user$project$Bingo$Model = function (a) {
	return {entries: a};
};
var _user$project$Bingo$Mark = function (a) {
	return {ctor: 'Mark', _0: a};
};
var _user$project$Bingo$Delete = function (a) {
	return {ctor: 'Delete', _0: a};
};
var _user$project$Bingo$entryItem = function (entry) {
	return A2(
		_elm_lang$html$Html$li,
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						{ctor: '_Tuple2', _0: 'highlight', _1: entry.wasSpoken}
					])),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text(entry.phrase)
					])),
				A2(
				_elm_lang$html$Html$span,
				_elm_lang$core$Native_List.fromArray(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(
						_user$project$Bingo$Delete(entry.id))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
};
var _user$project$Bingo$entryList = function (entries) {
	var entryItems = A2(_elm_lang$core$List$map, _user$project$Bingo$entryItem, entries);
	var items = A2(
		_elm_lang$core$Basics_ops['++'],
		entryItems,
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Bingo$totalItem(
				_user$project$Bingo$totalPoints(entries))
			]));
	return A2(
...
var _user$project$Bingo$view = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Bingo$pageHeader,
				_user$project$Bingo$entryList(model.entries),
				A2(
				_elm_lang$html$Html$button,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('sort'),
						_elm_lang$html$Html_Events$onClick(_user$project$Bingo$Sort)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Sort')
					])),
				_user$project$Bingo$pageFooter
			]));
};
var _user$project$Bingo$main = {
	main: _elm_lang$html$Html_App$beginnerProgram(
		{model: _user$project$Bingo$initialModel, update: _user$project$Bingo$update, view: _user$project$Bingo$view})
};
var _user$project$Bingo$NoOp = {ctor: 'NoOp'};
